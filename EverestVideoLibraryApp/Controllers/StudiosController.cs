...
namespace EverestVideoLibraryApp.Controllers
{
    public class StudiosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudioId,Name,Address,Phone,Email,Description")] Studio studio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudioId,Name,Address,Phone,Email,Description")] Studio studio)
        {
            if (ModelState.IsValid)
            {
