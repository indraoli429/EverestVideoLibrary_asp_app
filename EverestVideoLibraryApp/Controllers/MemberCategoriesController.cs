...
namespace EverestVideoLibraryApp.Controllers
{
    public class MemberCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MemberCatId,Category,Description,TotalDays,TotalLoan,FineAmountPerDay")] MemberCategory memberCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MemberCatId,Category,Description,TotalDays,TotalLoan,FineAmountPerDay")] MemberCategory memberCategory)
        {
            if (ModelState.IsValid)
            {
